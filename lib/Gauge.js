...
var Gauge = /** @class */ (function (_super) {
    ...
    Gauge.prototype.render = function () {
        ...
        let totalValue = this.props.value.reduce(function(acc, val) { return acc + val; });
        let total = totalValue;
        let parts = [];
        for (let i = 0; i < this.props.value.length; i++) {
          console.log(this.props.color)
          parts.push(react_1["default"].createElement("path", { fill: this.props.color[i], stroke: "none", d: this._getPath(total), filter: "url(#" + this.uniqueFilterId + ")" }))
          total -= this.props.value[i];
        }
        ...
        return (react_1["default"].createElement("svg", { height: "100%", version: "1.1", width: "100%", xmlns: "http://www.w3.org/2000/svg", style: { width: this.props.width, height: this.props.height, overflow: 'hidden', position: 'relative', left: 0, top: 0 } },
            ...
            ...parts,
            // react_1["default"].createElement("path", { fill: 'green', stroke: "none", d: this._getPath(this.props.value[0]), filter: "url(#" + this.uniqueFilterId + ")" }),
            // react_1["default"].createElement("path", { fill: this.props.color, stroke: "none", d: this._getPath(40), filter: "url(#" + this.uniqueFilterId + ")" }),
            // react_1["default"].createElement("path", { fill: 'red', stroke: "none", d: this._getPath(30), filter: "url(#" + this.uniqueFilterId + ")" }),
            ...
            react_1["default"].createElement("text", { x: this.props.width / 2, y: this.props.height / 5 * 4, textAnchor: "middle", style: valueLabelStyle }, totalValue + this.props.symbol + "%"),
